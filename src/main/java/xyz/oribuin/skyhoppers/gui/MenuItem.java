...
public class MenuItem {
    ...
    private Material customItem; // The item to be displayed
    ...
    public final void place(BaseGui gui) {
        ...
        if (this.slots.isEmpty()) {
            ...
            Integer slot = (Integer) this.config.get(this.itemPath + ".slot");
            if (slot != null) {
                this.slot(slot);
            }
        ...
        ItemStack item = new ItemBuilder(PluginUtils.getItemStack(this.config, this.itemPath, this.player, this.placeholders))
                .setMaterial(this.customItem)
                .create();

        if (item == null) {
            throw new IllegalArgumentException("Item cannot be null (" + this.itemPath + ")");
        }

        if (this.slots.isEmpty()) {
            throw new IllegalArgumentException("Slots cannot be empty (" + this.itemPath + ")");
        }
    ...
    public final MenuItem customItem(Material customItem) {
